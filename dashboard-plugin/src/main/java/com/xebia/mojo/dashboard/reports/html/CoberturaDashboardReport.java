...
public class CoberturaDashboardReport extends HtmlFileXPathReport implements LoggerAware
{
    ...
    private static final List COLUMN_NAMES =
        Arrays.asList(new String[] { "linecoverage", "branchcoverage", "complexity" });
            ...
            if (graph != null)
            {
                ...
                if (bar != null)
                {
                    HtmlUtil.addStyles(bar,
                        "background-color:#00F000; height:1.3em; padding:0px; border-collapse:collapse; ");
                ...
                HtmlUtil.addStyles(text,
                    "display:block; position:absolute; text-align:center; width:100px; border-collapse:collapse;");

...
public class CpdDashboardReport extends HtmlFileXPathReport
{
    ...
    /**
     * Method overridden because the super findNode cannot be used, we use a xpath function. The super class uses
     * {@link TidyXmlUtil#findElement(Node, String)} which cannot handle xpath functions.
     */

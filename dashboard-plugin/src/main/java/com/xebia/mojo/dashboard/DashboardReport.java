...
public interface DashboardReport {
    ...
    /**
     * Returns the title of the column shown on the screen in the dashboard. A report may have
     * multiple columns to show the information on the dashboard.
     * 
    ...
    /**
     * Whether the report has meaning/content for the given (sub) project. For instance is the
    ...
    /**
     * Returns the content for the given (sub) project and column. The result node will be placed in
     * the dashboard.
     */

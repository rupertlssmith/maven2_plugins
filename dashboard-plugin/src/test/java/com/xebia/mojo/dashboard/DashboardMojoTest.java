...
public class DashboardMojoTest extends AbstractMojoTestCase {
    ...
    public void testShouldAddTableWithJustProjectNameWhenNoReports() throws Exception {
        ...
        configureMojo(dashboardMojo, "maven-dashboard-plugin", getTestFile("src/test/resources/mojo/config/no-reports.xml"));
    ...
    public void testShouldAddTableWithAllReportsWhenNotConfigured() throws Exception {
        ...
        configureMojo(dashboardMojo, "maven-dashboard-plugin", getTestFile("src/test/resources/mojo/config/all-reports.xml"));
        dashboardMojo.execute();
    ...
    public void testShouldAddTableWithOneReportsWhenOneConfigured() throws Exception {
        ...
        configureMojo(dashboardMojo, "maven-dashboard-plugin", getTestFile("src/test/resources/mojo/config/one-report.xml"));
        dashboardMojo.execute();
    ...
    public void testShouldAddTableWithColumnsConfigured() throws Exception {
        ...
        configureMojo(dashboardMojo, "maven-dashboard-plugin", getTestFile("src/test/resources/mojo/config/columns-config.xml"));
        dashboardMojo.execute();
    ...
    public void testOneReportThatCanExecute() throws Exception {
        ...
        DashboardMojo mojo = new DashboardMojo() {

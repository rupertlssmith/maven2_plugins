...
public class CoberturaDashboardReportTest extends AbstractDashboardReportTester {
    ...
    protected void setUp() throws Exception {
        ...
        coberturaDashboardReport = new CoberturaDashboardReport() {
    ...
    public void testShouldRetrieveLineMetrics() throws Exception {
        ...
        assertEquals("background-color:#F02020; border:1px solid #808080; height:1.3em; padding:0px; width:100px; border-collapse:collapse;", div
    ...
    public void testShouldParseOldFrameSummary() throws Exception {
        ...
        assertEquals("background-color:#F02020; border:1px solid #808080; height:1.3em; padding:0px; border-collapse:collapse;", td
                .attributeValue("style"));
